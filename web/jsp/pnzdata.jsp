    ...
    <body>
        ...
        <form method="POST" action="../PnzDataController">
           ...
           <ul>
               ...
               <li><a href="pnzdata.jsp?pnzId=<%=pnzId%>&pnzName=<%=URLEncoder.encode(pnzName, "UTF-16")%>&month=7">Июль</a></li>
               <li><a href="pnzdata.jsp?pnzId=<%=pnzId%>&pnzName=<%=URLEncoder.encode(pnzName, "UTF-16")%>&month=8">Август</a></li>
               <li><a href="pnzdata.jsp?pnzId=<%=pnzId%>&pnzName=<%=URLEncoder.encode(pnzName, "UTF-16")%>&month=9">Сентябрь</a></li>
